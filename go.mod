...
require (
	...
	github.com/go-lynx/lynx v0.1.0-beta
...
require (
	...
	github.com/go-kratos/kratos/contrib/polaris/v2 v2.0.0-20230830131453-6c026bce56a9 // indirect
...
replace github.com/go-lynx/lynx-layout/api => ../lynx-layout/api
